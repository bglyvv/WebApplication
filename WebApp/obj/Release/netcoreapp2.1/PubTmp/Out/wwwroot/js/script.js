$(document).ready(function () {
    $("#slider .images").children().first().addClass("active")
    ...
    $(".load_more").click(function () {
        $.ajax({
            ...
            success: function (response) {
                $(".product_mainlist").append(response);
                skip += 8;
    ...
    $(window).scroll(function () {
        if ($(window).scrollTop() > 500) {
            ...
            $('#main_nav').stop(true,true).removeClass("sticky");
        }
    });
    ...
    function prev() {
        ...
        if (prevImg.length == 1) {
            ...
            $("#slider .images .item .nextnumber").text("0" + 1)
            currentImg.removeClass("active")
            prevImg = $("#slider .images").children().last();
             prevImg.addClass("active")
            console.log(prevImg);
